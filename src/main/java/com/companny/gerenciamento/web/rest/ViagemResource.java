...
import com.companny.gerenciamento.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.companny.gerenciamento.domain.Viagem}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ViagemResource {
     ...
     */
    @PostMapping("/viagems")
    public ResponseEntity<Viagem> createViagem(@RequestBody Viagem viagem) throws URISyntaxException {
    ...
    public ResponseEntity<Viagem> updateViagem(@PathVariable(value = "id", required = false) final Long id, @RequestBody Viagem viagem)
    ...
    public ResponseEntity<Viagem> partialUpdateViagem(
        ...
        Optional<Viagem> result = viagemRepository
            ...
            .map(existingViagem -> {
                if (viagem.getPrevisaoDeEntrega() != null) {
                    existingViagem.setPrevisaoDeEntrega(viagem.getPrevisaoDeEntrega());
                }
                if (viagem.getEntregueNoPrazo() != null) {
                    existingViagem.setEntregueNoPrazo(viagem.getEntregueNoPrazo());
                }
                if (viagem.getPrevisaoDeRetorno() != null) {
                    existingViagem.setPrevisaoDeRetorno(viagem.getPrevisaoDeRetorno());
                }
