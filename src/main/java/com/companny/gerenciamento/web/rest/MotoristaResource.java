...
/**
 * REST controller for managing {@link com.companny.gerenciamento.domain.Motorista}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Motorista> partialUpdateMotorista(
        ...
        Optional<Motorista> result = motoristaRepository
            ...
            .map(existingMotorista -> {
                ...
                if (motorista.getGenero() != null) {
                    existingMotorista.setGenero(motorista.getGenero());
                }
