...
/**
 * REST controller for managing {@link com.companny.gerenciamento.domain.Caminhao}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CaminhaoResource {
    ...
    public ResponseEntity<Caminhao> createCaminhao(@Valid @RequestBody Caminhao caminhao) throws URISyntaxException {
    ...
    public ResponseEntity<Caminhao> updateCaminhao(
        ...
        @Valid @RequestBody Caminhao caminhao
    ...
    public ResponseEntity<Caminhao> partialUpdateCaminhao(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody Caminhao caminhao
    ) throws URISyntaxException {
        ...
        Optional<Caminhao> result = caminhaoRepository
            ...
            .map(existingCaminhao -> {
                ...
                if (caminhao.getCargaTotal() != null) {
                    existingCaminhao.setCargaTotal(caminhao.getCargaTotal());
                }
