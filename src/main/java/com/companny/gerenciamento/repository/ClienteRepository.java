...
public interface ClienteRepository extends JpaRepository<Cliente, Long> {
    ...
    @Query(
        value = "select distinct cliente from Cliente cliente left join fetch cliente.endereco",
    ...
    @Query("select distinct cliente from Cliente cliente left join fetch cliente.endereco")
    List<Cliente> findAllWithToOneRelationships();

    @Query("select cliente from Cliente cliente left join fetch cliente.endereco where cliente.id =:id")
