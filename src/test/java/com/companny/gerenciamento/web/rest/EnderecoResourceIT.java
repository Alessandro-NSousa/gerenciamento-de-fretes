...
import com.companny.gerenciamento.repository.EnderecoRepository;
...
class EnderecoResourceIT {
    ...
    void putNewEndereco() throws Exception {
        ...
        updatedEndereco.cep(UPDATED_CEP).logradouro(UPDATED_LOGRADOURO).complemento(UPDATED_COMPLEMENTO).numero(UPDATED_NUMERO);
    ...
    void partialUpdateEnderecoWithPatch() throws Exception {
        ...
        partialUpdatedEndereco.complemento(UPDATED_COMPLEMENTO).numero(UPDATED_NUMERO);
    ...
    void fullUpdateEnderecoWithPatch() throws Exception {
        ...
        partialUpdatedEndereco.cep(UPDATED_CEP).logradouro(UPDATED_LOGRADOURO).complemento(UPDATED_COMPLEMENTO).numero(UPDATED_NUMERO);
