...
import com.companny.gerenciamento.repository.DespesaRepository;
...
class DespesaResourceIT {
    ...
    private static final Tipo DEFAULT_TIPO_DESPESA = Tipo.MANUTENCAO;
    private static final Tipo UPDATED_TIPO_DESPESA = Tipo.ABASTECIMENTO;
    ...
    public static Despesa createEntity(EntityManager em) {
        Despesa despesa = new Despesa().tipoDespesa(DEFAULT_TIPO_DESPESA).descricao(DEFAULT_DESCRICAO).valor(DEFAULT_VALOR);
        return despesa;
    }
    ...
    public static Despesa createUpdatedEntity(EntityManager em) {
        Despesa despesa = new Despesa().tipoDespesa(UPDATED_TIPO_DESPESA).descricao(UPDATED_DESCRICAO).valor(UPDATED_VALOR);
        return despesa;
    }
    ...
    void createDespesa() throws Exception {
        ...
        assertThat(testDespesa.getTipoDespesa()).isEqualTo(DEFAULT_TIPO_DESPESA);
    ...
    void getAllDespesas() throws Exception {
        ...
        restDespesaMockMvc
            ...
            .andExpect(jsonPath("$.[*].tipoDespesa").value(hasItem(DEFAULT_TIPO_DESPESA.toString())))
    ...
    void getDespesa() throws Exception {
        ...
        restDespesaMockMvc
            ...
            .andExpect(jsonPath("$.tipoDespesa").value(DEFAULT_TIPO_DESPESA.toString()))
    ...
    void putNewDespesa() throws Exception {
        ...
        updatedDespesa.tipoDespesa(UPDATED_TIPO_DESPESA).descricao(UPDATED_DESCRICAO).valor(UPDATED_VALOR);
        ...
        Despesa testDespesa = despesaList.get(despesaList.size() - 1);
        assertThat(testDespesa.getTipoDespesa()).isEqualTo(UPDATED_TIPO_DESPESA);
    ...
    void partialUpdateDespesaWithPatch() throws Exception {
        ...
        partialUpdatedDespesa.tipoDespesa(UPDATED_TIPO_DESPESA).descricao(UPDATED_DESCRICAO);
    ...
    void fullUpdateDespesaWithPatch() throws Exception {
        ...
        partialUpdatedDespesa.tipoDespesa(UPDATED_TIPO_DESPESA).descricao(UPDATED_DESCRICAO).valor(UPDATED_VALOR);
