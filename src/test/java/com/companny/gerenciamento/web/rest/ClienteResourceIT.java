...
import com.companny.gerenciamento.domain.Cliente;
import com.companny.gerenciamento.repository.ClienteRepository;
...
class ClienteResourceIT {
    ...
    public static Cliente createEntity(EntityManager em) {
        Cliente cliente = new Cliente().nome(DEFAULT_NOME).cnpj(DEFAULT_CNPJ);
        return cliente;
    }
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        Cliente cliente = new Cliente().nome(UPDATED_NOME).cnpj(UPDATED_CNPJ);
        return cliente;
    }
    ...
    void putNewCliente() throws Exception {
        ...
        updatedCliente.nome(UPDATED_NOME).cnpj(UPDATED_CNPJ);
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.nome(UPDATED_NOME).cnpj(UPDATED_CNPJ);
