...
describe('Service Tests', () => {
  describe('Despesa Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Despesa(123, Tipo.MANUTENCAO, 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Despesa', async () => {
      ...
      it('should not update a Despesa', async () => {
      ...
      it('should partial update a Despesa', async () => {
      ...
      it('should not partial update a Despesa', async () => {
      ...
      it('should not return a list of Despesa', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Despesa', async () => {
