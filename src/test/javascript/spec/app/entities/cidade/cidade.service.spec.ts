...
describe('Service Tests', () => {
  describe('Cidade Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Cidade(123, 'AAAAAAA', Uf.AC);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Cidade', async () => {
      ...
      it('should not update a Cidade', async () => {
      ...
      it('should partial update a Cidade', async () => {
      ...
      it('should not partial update a Cidade', async () => {
      ...
      it('should not return a list of Cidade', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Cidade', async () => {
